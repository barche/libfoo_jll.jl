...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libfoo_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("dd129e56-5ae0-5dd4-9b36-b8cf5aa41e28"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libfoo", artifacts_toml) for e in artifacts["libfoo"]]
...
if best_platform === nothing
    @debug("Unable to load libfoo; unsupported platform $(triplet(platform_key_abi()))")
else
